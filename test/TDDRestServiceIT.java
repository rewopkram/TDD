...
/**
 * The purpose of this class is to attempt to include Rest end point integration tests with maven build.
 * In order to do that I need to get maven to deploy the war and start the tomcat instance before running these
 * tests. 
 * I havent been able to do that yet.
 * These tests can be run by the maven build but they will fail unless the war is deployed and running.
 * 
 * @author markpower
 *
 */
public class TDDRestServiceIT extends TDDFunctionalTest {
